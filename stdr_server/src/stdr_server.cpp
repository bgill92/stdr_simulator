  ...
  , _id(0)
{
  ...
  _loadExternalMapService =
      _nh.advertiseService("/stdr_server/load_static_map_external", &Server::loadExternalMapCallback, this);
  ...
  //!< Rviz publisher
  _sourceVectorPublisherRviz =
      _nh.advertise<visualization_msgs::MarkerArray>("stdr_server/sources_visualization_markers", 1, true);

  //!< Rfid tags

  _addRfidTagServiceServer = _nh.advertiseService("stdr_server/add_rfid_tag", &Server::addRfidTagCallback, this);

  _deleteRfidTagServiceServer =
      _nh.advertiseService("stdr_server/delete_rfid_tag", &Server::deleteRfidTagCallback, this);

  _rfidTagVectorPublisher = _nh.advertise<stdr_msgs::RfidTagVector>("stdr_server/rfid_list", 1, true);

  //!< CO2 sources

  _addCO2SourceServiceServer = _nh.advertiseService("stdr_server/add_co2_source", &Server::addCO2SourceCallback, this);

  _deleteCO2SourceServiceServer =
      _nh.advertiseService("stdr_server/delete_co2_source", &Server::deleteCO2SourceCallback, this);

  _CO2SourceVectorPublisher = _nh.advertise<stdr_msgs::CO2SourceVector>("stdr_server/co2_sources_list", 1, true);

  //!< Thermal sources

  _addThermalSourceServiceServer =
      _nh.advertiseService("stdr_server/add_thermal_source", &Server::addThermalSourceCallback, this);

  _deleteThermalSourceServiceServer =
      _nh.advertiseService("stdr_server/delete_thermal_source", &Server::deleteThermalSourceCallback, this);

  _thermalSourceVectorPublisher =
      _nh.advertise<stdr_msgs::ThermalSourceVector>("stdr_server/thermal_sources_list", 1, true);

  //!< Sound sources

  _addSoundSourceServiceServer =
      _nh.advertiseService("stdr_server/add_sound_source", &Server::addSoundSourceCallback, this);

  _deleteSoundSourceServiceServer =
      _nh.advertiseService("stdr_server/delete_sound_source", &Server::deleteSoundSourceCallback, this);

  _soundSourceVectorPublisher = _nh.advertise<stdr_msgs::SoundSourceVector>("stdr_server/sound_sources_list", 1, true);
}

/**
@brief Service callback for adding new rfid tag to the environment
**/
bool Server::addRfidTagCallback(stdr_msgs::AddRfidTag::Request& req, stdr_msgs::AddRfidTag::Response& res)
{
  ...
  _rfidTagMap.insert(std::pair<std::string, stdr_msgs::RfidTag>(new_rfid.tag_id, new_rfid));
...
**/
bool Server::addCO2SourceCallback(stdr_msgs::AddCO2Source::Request& req, stdr_msgs::AddCO2Source::Response& res)
{
  ...
  _CO2SourceMap.insert(std::pair<std::string, stdr_msgs::CO2Source>(new_source.id, new_source));
...
**/
bool Server::addThermalSourceCallback(stdr_msgs::AddThermalSource::Request& req,
                                      stdr_msgs::AddThermalSource::Response& res)
{
  ...
  _thermalSourceMap.insert(std::pair<std::string, stdr_msgs::ThermalSource>(new_source.id, new_source));
  ...
  for (ThermalSourceMapIt it = _thermalSourceMap.begin(); it != _thermalSourceMap.end(); it++)
  {
...
**/
bool Server::addSoundSourceCallback(stdr_msgs::AddSoundSource::Request& req, stdr_msgs::AddSoundSource::Response& res)
{
  //!< Sanity check for the source
  ...
  //!< Add source to the environment
  _soundSourceMap.insert(std::pair<std::string, stdr_msgs::SoundSource>(new_source.id, new_source));

  //!< Publish the new source list
  stdr_msgs::SoundSourceVector soundSourceList;
  visualization_msgs::MarkerArray soundMarkerArray;

  for (SoundSourceMapIt it = _soundSourceMap.begin(); it != _soundSourceMap.end(); it++)
  {
...
**/
bool Server::deleteRfidTagCallback(stdr_msgs::DeleteRfidTag::Request& req, stdr_msgs::DeleteRfidTag::Response& res)
{
...
**/
bool Server::deleteCO2SourceCallback(stdr_msgs::DeleteCO2Source::Request& req, stdr_msgs::DeleteCO2Source::Response& res)
{
  std::string name = req.name;
...
**/
bool Server::deleteThermalSourceCallback(stdr_msgs::DeleteThermalSource::Request& req,
...
**/
bool Server::deleteSoundSourceCallback(stdr_msgs::DeleteSoundSource::Request& req,
...
@return bool
**/
bool Server::loadMapCallback(stdr_msgs::LoadMap::Request& req, stdr_msgs::LoadMap::Response& res)
{
  if (_mapServer)
  {
...
@return bool
**/
bool Server::loadExternalMapCallback(stdr_msgs::LoadExternalMap::Request& req, stdr_msgs::LoadExternalMap::Response& res)
{
  if (_mapServer)
  {
    ROS_WARN("Map already loaded!");
...
bool Server::addNewRobot(stdr_msgs::RobotMsg description, stdr_msgs::SpawnRobotResult* result)
{
  ...
  result->message = "Robot didn't respond within time or registered with incorrect name.";
  lock.unlock();
  return false;
}
...
bool Server::hasDublicateFrameIds(const stdr_msgs::RobotMsg& robot, std::string& f_id)
{
