...
HandleRobot::HandleRobot()
  : _spawnRobotClient("stdr_server/spawn_robot", true), _deleteRobotClient("stdr_server/delete_robot", true)
{
}
...
stdr_msgs::RobotIndexedMsg HandleRobot::spawnNewRobot(const stdr_msgs::RobotMsg msg)
{
  ...
  {
    std::string msg = std::string("Could not spawn robot. ") + _spawnRobotClient.getResult()->message;
